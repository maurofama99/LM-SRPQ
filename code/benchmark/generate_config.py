...
def generate_config_files(output_folder, datasets, algorithms, window_slide_pairs, query_label_pairs, z_scores):
            ...
            for size, slide in window_slide_pairs:
                for query_type, labels in query_label_pairs:
                    for zscore in z_scores:
                        ...
                        config_filename = f"config_a{algorithm}_S{size}_s{slide}_q{query_type}_z{zscore}.txt"
...
def main():
    ...
    generate_config_files(output_folder, datasets, algorithms, window_slide_pairs, query_label_pairs, z_scores)
